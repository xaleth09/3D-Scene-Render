...
public class ColorType
{
	...
	/** Return this color plus color input */
	public ColorType add(ColorType inp){
		ColorType res = new ColorType(inp);
		res.r += (float)this.r;
		res.g += (float)this.g;
		res.b += (float)this.b;
	...
	/** Return this color multiplied by input color */
	public ColorType mult(ColorType inp){
		ColorType res = new ColorType(inp);
		res.r *= (float)this.r;
		res.g *= (float)this.g;
		res.b *= (float)this.b;
