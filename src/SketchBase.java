...
public class SketchBase 
{
	 ...
	 *          Point to be drawn.
	 */
	public static void drawPoint(BufferedImage buff, DepthBuffer db, Point2D p)
	{
	 ...
	 */
	public static void drawLine(BufferedImage buff, DepthBuffer dbuff, Point2D p1, Point2D p2)
	{
	    int x0=p1.x, y0=p1.y;
	    float z0= p1.z;
	    ...
	    if(x_y_role_swapped)
	    {
	    	if(x>=0 && x<buff.getHeight() && y>=0 && y<buff.getWidth()){
	    		if(dbuff.checkDepth(new Point2D(y, x, z, new ColorType(r<<16, (g<<8), b))) ){
	    			dbuff.updateDepth( new Point2D(y, x, z, new ColorType(r<<16, (g<<8), b)) );
	    ...
	    else
	    {
	    	if(y>=0 && y<buff.getHeight() && x>=0 && x<buff.getWidth()){
	    		if(dbuff.checkDepth(new Point2D(x, y, z, new ColorType(r<<16, (g<<8), b))) ){
	    			dbuff.updateDepth(new Point2D(x, y, z, new ColorType((r<<16),(g<<8), b) ));
	 ...
	 */
	public static void drawTriangle(BufferedImage buff, DepthBuffer dbuff, Point2D p1, Point2D p2, Point2D p3, boolean do_smooth)
	{
